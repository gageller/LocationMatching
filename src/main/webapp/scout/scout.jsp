	...
	<h3>Location Requests</h3>
			...
			<table width="1000" border="1">
				<tbody>
					...
					<tr>
						<fmt:formatDate  type="date" pattern="M/dd/yyyy" var="formattednDate" value="${locationRequest.submissionDate}" />
						<td>${formattednDate}</td>
						<fmt:formatDate  type="date" pattern="M/dd/yyyy" var="formattednDate" value="${locationRequest.shootBeginDate}" />
						<td>${formattednDate}</td>
						<fmt:formatDate  type="date" pattern="M/dd/yyyy" var="formattednDate" value="${locationRequest.shootEndDate}" />
						<td>${formattednDate}</td>
